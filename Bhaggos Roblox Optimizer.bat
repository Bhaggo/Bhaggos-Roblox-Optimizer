...
if not exist "%robloxDirectory%" (
    echo "Roblox/Versions directory not found."
    pause
    exit /b
)
...
if "%folderFound%"=="false" (
    for /d %%a in ("%robloxDirectory%\version-*") do (
        echo "ClientSettings folder not found in any version folder. Creating the folder.."
...
if exist "%directory%\ClientAppSettings.json" (
    ...
    echo "'ClientAppSettings.json' replaced in ClientSettings folder."
) else (
    ...
    echo "'ClientAppSettings.json' created in ClientSettings folder."
)
...
:open
@echo off
start "" "%LOCALAPPDATA%\Roblox\Versions\"
goto menu
...
if "%folderFound%"=="false" (
    echo "ClientSettings folder not found in any version folder."
    pause
    exit /b
)
...
:foundDirectory
if exist "%directory%\ClientAppSettings.json" (
    del "%directory%\ClientAppSettings.json"
    echo "'ClientAppSettings.json' deleted from ClientSettings folder."
) else (
    echo "'ClientAppSettings.json' not found in ClientSettings folder."
)
